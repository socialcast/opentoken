...
Gem::Specification.new do |s|
  ...
  s.date = "2011-10-13"
  s.description = "parse opentoken properties passed for Single Signon requests"
  ...
  s.homepage = "http://github.com/wireframe/opentoken"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.11"
  s.summary = "ruby implementation of the opentoken specification"
  s.test_files = [
    "test/helper.rb",
    "test/test_opentoken.rb"
  ]
